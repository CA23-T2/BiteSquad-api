                ...
                photoArea.innerHTML =
                    ...
                    <div>
                        ...
                        <div class="d-flex justify-content-center mt-2 border border-black">
                            <img style="max-width: 100%; height: 300px; object-fit: cover;" id="imagePreview" src="{{url($meal->image_url)}}" alt="Prikaz nije dostupan.">
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-12">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="meal_name" name="meal_name" value="{{$meal->meal_name}}" placeholder="Unesite naziv obroka...">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="{{$meal->dietary_restrictions}}" id="dietary_restrictions" name="dietary_restrictions"
